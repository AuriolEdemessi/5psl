          ...
          <div id="searchDropdownMenu" class="hs-form-search-menu-content dropdown-menu dropdown-menu-form-search navbar-dropdown-menu-borderless">
            ...
            <div class="card-body-height">
              ...
              <a class="dropdown-item" href="index.html">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
                    <img class="avatar avatar-xs avatar-circle" src="profil/assets/img/160x160/img10.jpg" alt="Image Description">
                  </div>
                  <div class="flex-grow-1 text-truncate ms-2">
              ...
              <a class="dropdown-item" href="index.html">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
                    <img class="avatar avatar-xs avatar-circle" src="profil/assets/img/160x160/img3.jpg" alt="Image Description">
                  </div>
                  <div class="flex-grow-1 text-truncate ms-2">
                          ...
                          <div class="row">
                            <div class="col-auto">
                              <div class="d-flex align-items-center">
                                ...
                                <img class="avatar avatar-sm avatar-circle" src="profil/assets/img/160x160/img3.jpg" alt="Image Description">
                              </div>
                            </div>
                            <!-- End Col -->
                          ...
                          <div class="row">
                            <div class="col-auto">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="profil/assets/svg/brands/google-icon.svg" alt="Image Description">
                                </div>
                              </div>
                            </div>
                            <!-- End Col -->
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-card navbar-dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="navbarAppsDropdown" style="width: 25rem;">
                ...
                <div class="card-body card-body-height">
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img class="avatar avatar-xs avatar-4x3" src="profil/assets/svg/brands/atlassian-icon.svg" alt="Image Description">
                      </div>
